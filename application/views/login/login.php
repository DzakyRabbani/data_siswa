<!DOCTYPE html>
	<html lang="en" dir="ltr" style="background-color : #0CB5D3;">
	<head>
		<meta charset="utf-8">
		<title>FORM LOGIN APLIKASI DATA SISWA</title>
		<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/style/html.css">
		<link rel="icon" type="image/png" href="<?php echo base_url('assets/img/background/smkwikrama.png') ?>"/>
	</head>
	<body>
	<div class="limiter">
	...
	<?= $this->session->flashdata('message'); ?>
		<span class="login100-form-title p-b-30 animated fadeInDown" style="font-family: sans-serif;font-size: 300%;margin-top: -10%">
						<img width="40%" src="<?php echo base_url('assets/img/background/smkwikrama.png') ?>" alt=""><br>
						<!-- <i>Newsletter</i> -->
					</span>
